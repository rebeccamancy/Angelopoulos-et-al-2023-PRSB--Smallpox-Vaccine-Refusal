# Table_S14 equiv to Table 2 for RDs - a four column table, deaths and death rate both linear and non-linear models
# Dependant variable is COV as a percentage of surviving children (RD baseline model)
...
OLS_df <- read_excel(path = "Output_data/Results_RD_OLS_Baseline.xlsx")
fracreg_df <- read_excel(path = "Output_data/Results_RD_fracreg_Baseline.xlsx")
...
fileConn <- file("tables/Table_SM_COV_RD.html", )
