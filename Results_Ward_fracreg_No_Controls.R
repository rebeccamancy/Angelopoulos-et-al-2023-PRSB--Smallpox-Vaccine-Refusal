# Using LOGIT fractional regression to model impact of prior experience on COV, without controls
# Used in Figure 3 of the main manuscript
...
write_xlsx(fracreg_df, paste0("Output_data/Results_Ward_fracreg_No_Controls.xlsx"))
write.csv(x = fracreg_df, file = paste0("Output_data/Results_Ward_fracreg_No_Control.csv"))
