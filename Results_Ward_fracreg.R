...
# Ward level data
# Deaths and death rate used in Table 2 and Figures 2 and 3 of the main manuscript
# Cases and case rate used in SM
...
write_xlsx(fracreg_df, paste0("Output_data/Results_Wards_fracreg_Baseline.xlsx"))
write.csv(x = fracreg_df, file = paste0("Output_data/Results_Wards_fracreg_Baseline.csv"))
