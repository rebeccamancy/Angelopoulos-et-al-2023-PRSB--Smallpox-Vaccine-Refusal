# Produces base model results (OLS with clustered SE) including distance from Belvidere
...
#    (used to compute SD_change_effect for time-invariant variables)
...
write_xlsx(OLS_df, paste0("Output_data/Results_Ward_OLS_Belv.xlsx"))
write.csv(x = OLS_df, file = paste0("Output_data/Results_Ward_OLS_Belv.xlsx"))
