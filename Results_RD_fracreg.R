...
# Registration district version.
# Runs model for COV then COVRU then RU only
...
cases_fracreg_cl_vcov_mat <- vcovCL(cases_fracreg, cluster = ~Registration_district_name)
...
# Compute covariance matrix
case_rate_fracreg_cl_vcov_mat <- vcovCL(case_rate_fracreg, cluster = ~Registration_district_name)
...
# Compute covariance matrix
deaths_fracreg_cl_vcov_mat <- vcovCL(deaths_fracreg, cluster = ~Registration_district_name)
...
# Compute covariance matrix
death_rate_fracreg_cl_vcov_mat <- vcovCL(death_rate_fracreg, cluster = ~Registration_district_name)
...
write_xlsx(fracreg_df, paste0("Output_data/Results_RD_fracreg_Baseline.xlsx"))
write.csv(x = fracreg_df, file = paste0("Output_data/Results_RD_fracreg.csv"))

####################################################################################
#### COV and RU TOGETHER ####
# CASES
cases_fracreg <- glm(COV_RU_surv_perc ~ Smallpox_cases * Year_Numeric +
                       Population_density_1911 + 
                       Average_rooms_1911 + Perc_Irish_Born_1901,  
                     data = COV, 
                     family = quasibinomial('logit')) # fracreg logit
...
# CASES PER THOU
case_rate_fracreg <- glm(COV_RU_surv_perc ~ Smallpox_case_rate * Year_Numeric +
                           Population_density_1911 + 
                           Average_rooms_1911 + Perc_Irish_Born_1901 , 
                         data = COV, family = quasibinomial('logit'))
summary(case_rate_fracreg)
...
# DEATHS 
deaths_fracreg <- glm(COV_RU_surv_perc ~ Smallpox_deaths * Year_Numeric +
                        Population_density_1911 + 
                        Average_rooms_1911 + Perc_Irish_Born_1901, 
                      data = COV, family = quasibinomial('logit'))
summary(deaths_fracreg)
...
# DEATHS PER THOU
death_rate_fracreg <- glm(COV_RU_surv_perc ~ Smallpox_death_rate * Year_Numeric +
                            Population_density_1911 + 
                            Average_rooms_1911 + Perc_Irish_Born_1901 , 
                          data = COV, family = quasibinomial('logit'))
summary(death_rate_fracreg)
...
write_xlsx(fracreg_df, paste0("Output_data/Results_RD_fracreg_COVRU.xlsx"))

#### RU ONLY ####
# CASES
cases_fracreg <- glm(RU_surv_perc ~ Smallpox_cases * Year_Numeric +
                       Population_density_1911 + 
                       Average_rooms_1911 + Perc_Irish_Born_1901,  
                     data = COV, 
                     family = quasibinomial('logit')) # fracreg logit
...
# CASES PER THOU
case_rate_fracreg <- glm(RU_surv_perc ~ Smallpox_case_rate * Year_Numeric +
                           Population_density_1911 + 
                           Average_rooms_1911 + Perc_Irish_Born_1901 , 
                         data = COV, family = quasibinomial('logit'))
summary(case_rate_fracreg)
...
# DEATHS 
deaths_fracreg <- glm(RU_surv_perc ~ Smallpox_deaths * Year_Numeric +
                        Population_density_1911 + 
                        Average_rooms_1911 + Perc_Irish_Born_1901, 
                      data = COV, family = quasibinomial('logit'))
summary(deaths_fracreg)
...
# DEATHS PER THOU
death_rate_fracreg <- glm(RU_surv_perc ~ Smallpox_death_rate * Year_Numeric +
                            Population_density_1911 + 
                            Average_rooms_1911 + Perc_Irish_Born_1901 , 
                          data = COV, family = quasibinomial('logit'))
summary(death_rate_fracreg)
...
write_xlsx(fracreg_df, paste0("Output_data/Results_RD_fracreg_RU.xlsx"))
