# Table_S15 equiv to Table 2 for RDs but including removed/unaccounted for
# - a four column table, deaths and death rate both linear and non-linear models
# Dependent variable is COVRU
...
OLS_df <- read_excel(path = "Output_data/Results_RD_OLS_COVRU.xlsx")
fracreg_df <- read_excel(path = "Output_data/Results_RD_fracreg_COVRU.xlsx")
...
fileConn <- file("tables/Table_SM_COVRU_RD.html", )
