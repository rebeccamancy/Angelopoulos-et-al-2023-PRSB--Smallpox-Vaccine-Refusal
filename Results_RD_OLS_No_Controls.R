...
cases_OLS <- lm_robust(COV_surv_perc ~ Smallpox_cases * Year_Numeric, 
                       cluster = COV$Reg_district_number,
...
write_xlsx(OLS_df, paste0("Output_data/Results_RD_OLS_No_Controls.xlsx"))
write.csv(x = OLS_df, file = paste0("Output_data/Results_RD_OLS_No_Controls.csv"))
