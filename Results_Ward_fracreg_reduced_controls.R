...
write_xlsx(fracreg_df, paste0("Output_data/Results_Wards_fracreg_without_rooms.xlsx"))
...
write_xlsx(fracreg_df, paste0("Output_data/Results_Wards_fracreg_without_pop_density.xlsx"))
