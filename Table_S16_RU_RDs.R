# Table_S16 equiv to Table 2 for RDs but for removed/unaccounted for only
...
OLS_df <- read_excel(path = "Output_data/Results_RD_OLS_RU.xlsx")
fracreg_df <- read_excel(path = "Output_data/Results_RD_fracreg_RU.xlsx")
...
fileConn <- file("tables/Table_SM_RU_RD.html", )
