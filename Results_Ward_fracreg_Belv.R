...
# Includes distance from Belivedere hospital. Used in SM
...
write_xlsx(fracreg_df, paste0("Output_data/Results_Wards_fracreg_Belv.xlsx"))
write.csv(x = fracreg_df, file = paste0("Output_data/Results_Wards_fracreg_Belv.csv"))
