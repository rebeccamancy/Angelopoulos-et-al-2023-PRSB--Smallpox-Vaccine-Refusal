# Table_S9 - a four column table, deaths and death rate for WARDS both linear and non-linear models
# Including Distance from Belvidere
...
OLS_df <- read_excel(path = "Output_data/Results_Ward_OLS_Belv.xlsx")
fracreg_df <- read_excel(path = "Output_data/Results_Wards_fracreg_Belv.xlsx")
...
results_table$Variable_name <- factor(results_table$Variable_name,
                                      levels = c("(Intercept)","Smallpox","Smallpox x year","Year_Numeric",
                                                 "Population_density_1911","Average_rooms_1911","Perc_Irish_Born_1901", "Distance_Belvidere"),
                                      labels = c("(Intercept)","Smallpox","Smallpox x year","Year",
                                                 "Population density","Rooms per dwelling","Percent Irish born", "Distance from Belvidere"))
...
fileConn <- file("tables/Table_SM_Belvidere.html", )
